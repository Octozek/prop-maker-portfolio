const backdropsData = [

  {
    id: 2,
    title: "Obsidian",
    mainImage: "/assets/backdrops/Obsidian/Obsidian-main.JPG",
    mainImageComment: "Here’s the finished custom terrarium background I made for a client. They requested a darker backdrop with a large rock feature that stretches across from one side to the other — and that’s exactly what I created.",
    images: [

      { id: 201, src: "/assets/backdrops/Obsidian/Obsidian-1.JPG", comment: "The wall is fully assembled and glued together, ready for carving. I used 2-inch insulation foam as the base for this build." },
      { id: 202, src: "/assets/backdrops/Obsidian/Obsidian-2.JPG", comment: "Starting the sculpting process here — roughing in the basic rock shapes with carving tools." },
      { id: 203, src: "/assets/backdrops/Obsidian/Obsidian-3.JPG", comment: "Continuing the sculpt with a wire spin brush attached to a drill. This adds deep texture and natural rock-like grooves throughout the surface." },
      { id: 204, src: "/assets/backdrops/Obsidian/Obsidian-4.JPG", comment: "Here it is fully sculpted, sealed with heat from a heat gun, and prepped for drylock. This helps lock in the foam’s shape and adds durability." },
      { id: 205, src: "/assets/backdrops/Obsidian/Obsidian-5.JPG", comment: "Applying the first coat of drylock to give the foam that natural rock texture. Once dry, it’ll be painted and finished with a pet-safe sealant." },
    ],
  },
  {
    id: 3,
    ...
    images: [
      { id: 301, src: "/assets/backdrops/Charcoal-Ridge-1.jpg", comment: "Here you can see me using the airbrush to bring out the depth in all the cracks and crevices. I used Drylok mixed with acrylics for the base, then shaded the recessed areas with darker tones to make the textures pop. This backdrop has a cooler, grey-toned color palette to match the “charcoal” vibe." },
      { id: 302, src: "/assets/backdrops/Charcoal-Ridge-2.jpg", comment: "The client requested a more rocky bottom area, so I added more jagged texture and ledges toward the base. You can really see it here — rough, craggy, and perfect for climbing or resting. After all the paintwork, I sealed everything to lock in the finish and keep it durable for long-term use." },
    ],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    images: [
      { id: 601, src: "/assets/backdrops/Rusty-Rock-1.jpg", comment: "From this angle, you can see the depth really come to life. After shaping and heat-treating the foam, I applied a base coat of Drylok mixed with acrylics. Then I used an airbrush to darken the deep crevices and shadowed areas, adding contrast and realism." },
      { id: 602, src: "/assets/backdrops/Rusty-Rock-2.jpg", comment: "To finish it off, I drybrushed lighter tones across the raised edges to highlight the textures and give it that final pop. Once the painting was done, I sealed the whole thing to protect the finish and keep it looking fresh long-term." },
    ],
  },
  {
    id: 7,
    ...
    images: [
      { id: 701, src: "/assets/backdrops/Rusty-Cliff-Stone-1.jpg", comment: "Here you can see the side angle, where I applied a dark wash using watered-down black paint over the base colors. This helped deepen the shadows in the cracks and crevices and gave the whole piece a more weathered and realistic look. The orange tones still come through but now with more contrast and depth." },
      { id: 702, src: "/assets/backdrops/Rusty-Cliff-Stone-2.jpg", comment: "This final image shows the backdrop on my workbench before shipping. After painting, I drybrushed lighter highlights across the high points and sealed the whole piece to protect the finish. It’s ready for a reptile to climb, bask, and explore." },
    ],
  },
  {
    id: 8,
    ...
    images: [
      { id: 801, src: "/assets/backdrops/Charcoal-Deep-Rock-1.jpg", comment: "Here I’m using my airbrush to add depth and contrast to the piece. I painted the base using Drylok mixed with grey acrylics, then added darker tones in the crevices to bring out the natural details while still keeping that smooth, minimalist look the client wanted." },
      { id: 802, src: "/assets/backdrops/Charcoal-Deep-Rock-2.jpg", comment: "This last shot shows me airbrushing the piece at scale. You can see just how large this backdrop is in person. Once the shading was done, I sealed everything to protect the finish and keep it looking great inside the enclosure long-term." },
    ],
  },
  {
    id: 9,
